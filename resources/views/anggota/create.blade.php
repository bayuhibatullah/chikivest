                    ...
                    <div class="card-body">
                      <h4 class="card-title">Tambah Anggota baru</h4>
                        ...
                        <div class="form-group{{ $errors->has('npm') ? ' has-error' : '' }}">
                            <label for="npm" class="col-md-4 control-label">Username</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('prodi') ? ' has-error' : '' }}">
                            <label for="prodi" class="col-md-4 control-label">Alamat</label>
                            <div class="col-md-6">
                              <input id="npm" type="number" class="form-control" name="npm" value="{{ old('npm') }}" maxlength="8" required>
                              @if ($errors->has('npm'))
                                  <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('npm') ? ' has-error' : '' }}">
                            <label for="npm" class="col-md-4 control-label">Nomer Telepon</label>
                            <div class="col-md-6">
                                <input id="npm" type="number" class="form-control" name="npm" value="{{ old('npm') }}" maxlength="8" required>
                                @if ($errors->has('npm'))
                                    <span class="help-block">
